...
import Securities from "../screens/private/Securities";
    ...
    <div id="wrapper">
      ...
      >
        ...
        >
          ...
          <div class="sidebar-brand-text mx-3">Visitor | Admin</div>
        </a>
        ...
        <li class="nav-item">
          <Link class="nav-link" to="/residents/add">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Add Residents</span>
          </Link>
        </li>
        <li class="nav-item">
          <Link class="nav-link" to="/securities">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Securities</span>
          </Link>
        </li>
        <li class="nav-item">
          <Link class="nav-link" to="/securities/add">
            <i class="fas fa-fw fa-tachometer-alt"></i>
            <span>Add securities</span>
          </Link>
        </li>
      </ul>
